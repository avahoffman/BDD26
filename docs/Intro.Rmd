...
> Try adding a comma (,) to the 1000 on line 87. Do you get an error?
...
> On lines 106 and 116, change the breaks to include the most recent year.
...
> On line 117, change the y axis text to be "% of Residents with a Library Card".
...
> Instead of grouping by "year" on line 127, try grouping by Community Statistical Area ("CSA2020").
