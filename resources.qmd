...
- [Data Science for Environmental Health](https://daseh.org/index.html) - DaSEH is tailored for beginners and novices in R programming, offering instruction on importing, wrangling, visualizing, and analyzing data
- [https://jhudatascience.org/intro_to_r/](Introduction to R for Public Health Researchers) - Our course at JHU's School of Public Health
